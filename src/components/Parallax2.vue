      ...
      animateElement () {
        ...
        if (this.parallaxChildren.length > 0) {
          ...
          this.parallaxChildren.forEach((d) => {
            ...
            d.style.transform = `translate3d(${leftoffset}px, ${parallaxoffset + parseInt(d.dataset.originoffset)}px ,0)`
...
//            }
        ...
        this.el.style.transform = `translate3d(0, ${-offset + this.accumulatedOffset + parallaxOffset}px ,0)`
      },
