<template>
  <div class="home-content">
    ...
    <div class="home-content-logo hover-box" id="hover-box">
      ...
      <img class="hover-content" id="logo-J" :style="hoverContentStyle1" src="../assets/J.svg"/>
      <img class="hover-content" id="logo-ames" :style="hoverContentStyle2" src="../assets/ames.svg"/>
      <img class="hover-content" id="logo-Y" :style="hoverContentStyle3" src="../assets/Y.svg"/>
      <img class="hover-content" id="logo-ong" :style="hoverContentStyle4" src="../assets/ong.svg"/>
      <img class="hover-content" id="logo-42" :style="hoverContentStyle5" src="../assets/42.svg"/>
    </div>
  </div>
</template>
...
//      },
    ...
    mounted () {
      ...
      var parallaxStars = new Parallax(stars)
      console.log(parallaxStars)
    },
    beforeRouterLeave () {
